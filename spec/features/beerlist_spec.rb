...
describe "beerlist page" do
  ...
  it "beers ordered by name by default", js: true do
    visit beerlist_path
  ...
  it "beers ordered by style after clicking style", js: true do
    visit beerlist_path
    click_link('style')
  ...
  it "beers ordered by brewery after clicking brewery", js: true do
    visit beerlist_path
    click_link('brewery')
